...
const EXERCISE_TIPS = {
  ...
  'ブルガリアンスクワット(アセンディング)': {
    part:'legs', phase:['m'],
    muscle:['大腿四頭筋','大臀筋','ハムストリング'],
    desc:'20回→15回→10回と重量を上げながら行うアセンディング方式。左右別に3セット記録する。',
    tips:['弱い側から始める','上体をやや前傾させて臀部にも効かせる','膝が内側に入らないようにする']
  },
  'ワイドスタンス・スクワット': {
    part:'legs', phase:['m'],
    muscle:['内転筋','大臀筋','大腿四頭筋'],
    desc:'足幅を広めに取るスクワット。10〜12回を2セット、内転筋と臀部への刺激を強める。',
    tips:['つま先と膝の向きをそろえる','しゃがみ込みで骨盤を丸めすぎない','床を外へ割る意識で立つ']
  },
  '1と4分の1レッグエクステンション': {
    part:'legs', phase:['m'],
    muscle:['大腿四頭筋'],
    desc:'1回ごとに4分の1可動域を追加するレッグエクステンション。8〜10回を2セット。',
    tips:['トップ付近で四頭筋を強く収縮','反動で蹴り上げない','下ろしを丁寧にする']
  },
  '1と2分の1レッグカール': {
    part:'legs', phase:['m'],
    muscle:['ハムストリング'],
    desc:'1回ごとに半分の可動域を追加するレッグカール。10〜12回を2セット。',
    tips:['骨盤を浮かせない','収縮位置で一瞬止める','戻しでハムを伸ばす']
  },
  'ダンベル・ワンレッグカーフレイズ': {
    part:'legs', phase:['m'],
    muscle:['腓腹筋','ヒラメ筋'],
    desc:'片脚で行うダンベルカーフレイズ。10〜12回を左右別に2セット。',
    tips:['最下点でふくらはぎを伸ばす','トップでしっかり止める','反動で跳ねない']
  },
  'シーテッドカーフレイズ': {
    part:'legs', phase:['m'],
    muscle:['ヒラメ筋'],
    desc:'座位で行うカーフレイズ。Phase1では10〜12回を1セット。',
    tips:['膝を曲げた状態でふくらはぎを収縮','可動域を大きく取る','トップで1秒止める']
  },
  'ハックスクワット(重)': {
    part:'legs', phase:['h'],
    muscle:['大腿四頭筋','大臀筋'],
    desc:'高重量Phaseの主力スクワット。レストポーズ法で3回→2回→1回→1回を目安に行う。',
    tips:['腰が丸まらない深さで行う','膝の向きをつま先とそろえる','セーフティを必ず設定する']
  },
  'ブルガリアンスクワット(重)': {
    part:'legs', phase:['h'],
    muscle:['大腿四頭筋','大臀筋'],
    desc:'高重量で行うブルガリアンスクワット。6〜7回を左右別に2セット。',
    tips:['弱い側から始める','上体を安定させる','膝が内側へ入らないようにする']
  },
  'レッグエクステンション(重)': {
    part:'legs', phase:['h'],
    muscle:['大腿四頭筋'],
    desc:'高重量Phaseのレッグエクステンション。6〜7回を2セット、必要なら一人ネガティブで行う。',
    tips:['上げは補助しても下ろしを丁寧に','トップで四頭筋を収縮','膝に違和感があれば重量を下げる']
  },
  'レッグカール(重)': {
    part:'legs', phase:['h'],
    muscle:['ハムストリング'],
    desc:'高重量Phaseのレッグカール。6〜7回を2セット、必要なら一人ネガティブで行う。',
    tips:['骨盤を固定する','下ろしを3〜4秒かける','腰で反らない']
  },
  'レッグプレスマシンカーフレイズ(一人ネガティブ)': {
    part:'legs', phase:['h'],
    muscle:['腓腹筋','ヒラメ筋'],
    desc:'レッグプレスマシンで行うカーフレイズ。6〜8回を2セット、下ろしを丁寧に行う。',
    tips:['膝を伸ばしきって固定しすぎない','最下点で伸ばす','トップで強く収縮']
  },
  'シーテッドカーフレイズ(重)': {
    part:'legs', phase:['h'],
    muscle:['ヒラメ筋'],
    desc:'高重量Phaseのシーテッドカーフレイズ。6〜8回を1セット。',
    tips:['下ろしを丁寧にする','反動を使わない','トップで1秒止める']
  },
  'バーベルorマシンハックスクワット': {
    part:'legs', phase:['l'],
    muscle:['大腿四頭筋','大臀筋'],
    desc:'低重量Phaseのハックスクワット。25〜35回を3セット。',
    tips:['呼吸を止めず一定テンポで行う','膝が内側に入らないようにする','焼ける感覚を狙う']
  },
  'シシースクワット': {
    part:'legs', phase:['l'],
    muscle:['大腿四頭筋'],
    desc:'大腿四頭筋を強く伸ばしながら行うシシースクワット。25〜35回を2セット。',
    tips:['膝に違和感があれば浅めにする','体を一直線に保つ','反動を使わない']
  },
  'ボール・ハムストリングカール': {
    part:'legs', phase:['l'],
    muscle:['ハムストリング','大臀筋'],
    desc:'バランスボールで行うハムストリングカール。25〜35回を2セット。',
    tips:['腰を落としすぎない','踵でボールを引く','収縮位置で止める']
  },
  'ヒップスラスト': {
    part:'legs', phase:['l'],
    muscle:['大臀筋','ハムストリング'],
    desc:'臀部を狙うヒップスラスト。25〜35回を2セット。',
    tips:['トップで骨盤を後傾する','腰を反らせすぎない','臀部で持ち上げる']
  },
  'ワンレッグカーフレイズ': {
    part:'legs', phase:['l'],
    muscle:['腓腹筋','ヒラメ筋'],
    desc:'片脚で行うカーフレイズ。25〜35回を左右別に2セット。',
    tips:['最下点で伸ばす','トップで止める','回数を稼ぐだけにならないようにする']
  },
  'シーテッドカーフレイズ(軽)': {
    part:'legs', phase:['l'],
    muscle:['ヒラメ筋'],
    desc:'低重量Phaseのシーテッドカーフレイズ。25〜35回を2セット。',
    tips:['可動域を大きく取る','トップで1秒止める','最後までテンポを保つ']
  },
