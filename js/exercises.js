...
const EXERCISES = {
  ...
  shoulders: [
    ...
    { name: 'インクラインサイドレイズ',            rec: 8,  t: ['m'],     bilateral: true },
    { name: 'インクラインフロントレイズ',          rec: 10, t: ['m'],     bilateral: true },
    { name: 'スミスRGフロントプレス',             rec: 10, t: ['m']     },
    { name: 'アップライトロウ',                   rec: 10, t: ['m']     },
    { name: 'ロープリアレイズ',                   rec: 15, t: ['l']     },
    { name: 'サイドライイングリアレイズ',          rec: 15, t: ['l'],     bilateral: true },
...
const EXERCISE_TIPS = {
  ...
  'インクラインフロントレイズ': {
    part:'shoulders', phase:['m'],
    muscle:['三角筋前部','大胸筋上部'],
    desc:'インクラインで前部三角筋のストレッチを最大化するフロントレイズ。8〜10rep。',
  ...
  'サイドライイングリアレイズ': {
    part:'shoulders', phase:['l'],
    muscle:['三角筋後部'],
    desc:'横向きに寝てダンベルを持ち上げる後部三角筋の孤立種目。15〜20rep。',
